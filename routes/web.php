...
Route::resource('revervation', RevervationController::class);

Route::get('get-room-by-category/{id}', [RevervationController::class, 'getRoomCategory'])->name('get-room-by-category');
